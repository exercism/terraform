...
locals {
  ...
  # Fetched via: gh api -X GET search/repositories --paginate -f q='org:exercism is:public archived:false' --jq '.items[].name' | sort | awk '{ print "\"" $1 "\"," }'
  github_repos = toset([
    ".github",
    "05ab1e",
    "8th",
    ...
    "generic-test-runner",
    "generic-track",
    "gha-ensure-issue-authorization",
    "github-actions",
    "gleam",
    "gleam-analyzer",
    "gleam-representer",
    ...
    "javascript",
    "javascript-analyzer",
    "javascript-lib-jest-extensions",
    "javascript-lib-static-analysis",
