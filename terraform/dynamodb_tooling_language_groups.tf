  ...
  item = <<ITEM
{
  ...
  "languages": {"S": "abap,awk,bash,c,cfml,clojure,clojurescript,crystal,coffeescript,common-lisp,cpp,csharp,d,dart,elixir,elm,emacs-lisp,erlang,fortran,fsharp,go,groovy,haskell,haxe,j,java,javascript,julia,kotlin,lfe,lua,mips,nim,ocaml,perl5,php,prolog,purescript,python,r,racket,raku,red,ruby,reasonml,rust,scala,scheme,sml,swift,tcl,typescript,unison,vbnet,vimscript,wasm,wren,x86-64-assembly"}
}
ITEM
}
