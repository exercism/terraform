  ...
  item = <<ITEM
{
  ...
  "languages": {"S": "bash,c,cfml,clojure,clojurescript,crystal,coffeescript,common-lisp,cpp,csharp,d,dart,elixir,elm,emacs-lisp,erlang,fsharp,generic,go,groovy,j,java,javascript,julia,kotlin,lfe,lua,mips,nim,ocaml,perl5,php,prolog,purescript,python,r,racket,raku,ruby,reasonml,rust,scala,scheme,sml,swift,tcl,typescript,vimscript,x86-64-assembly"}
}
ITEM
}
