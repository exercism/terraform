  ...
  item = <<ITEM
{
  ...
  "languages": {"S": "bash,c,clojure,common-lisp,cpp,csharp,elixir,elm,erlang,fsharp,generic,go,j,java,javascript,julia,kotlin,lua,nim,ocaml,php,prolog,python,ruby,rust,scheme,sml,swift,tcl,vimscript,x86-64-assembly"}
}
ITEM
}
