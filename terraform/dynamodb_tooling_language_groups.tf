  ...
  item = <<ITEM
{
  ...
  "languages": {"S": "bash,c,cfml,clojure,coffeescript,common-lisp,cpp,csharp,elixir,elm,erlang,fsharp,generic,go,j,java,javascript,julia,kotlin,lua,nim,ocaml,perl5,php,prolog,python,r,racket,raku,ruby,reasonml,rust,scala,scheme,sml,swift,tcl,typescript,vimscript,x86-64-assembly"}
}
ITEM
}
