  ...
  item = <<ITEM
{
  ...
  "languages": {"S": "bash,c,clojure,common-lisp,cpp,csharp,elixir,elm,erlang,fsharp,generic,go,j,java,javascript,julia,kotlin,lua,nim,ocaml,php,prolog,python,ruby,reasonml,rust,scheme,sml,swift,tcl,typescript,vimscript,x86-64-assembly"}
}
ITEM
}
  ...
  item = <<ITEM
{
  ...
  "languages": {"S": "c,clojure,common-lisp,csharp,elixir,elm,fsharp,j,java,javascript,nim,python,ruby,rust"}
}
ITEM
}
