  ...
  item = <<ITEM
{
  ...
  "languages": {"S": "clojure,common-lisp,csharp,elixir,elm,fsharp,j,javascript,nim,python,ruby,rust"}
}
ITEM
}
  ...
  item = <<ITEM
{
  ...
  "languages": {"S": "clojure,common-lisp,csharp,elixir,erlang,go,java,javascript,nim,python,ruby,rust,scala,typescript"}
}
ITEM
}
